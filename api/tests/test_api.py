...
def test_predict_single_normal_flow():
    payload = {
...
def test_predict_single_dos_like_flow():
    payload = {
...
def test_predict_missing_fields_uses_defaults():
...
def test_batch_predict_with_sample_csv(tmp_path):
...
def test_batch_predict_rejects_bad_columns():
    import io
